...
Original file is located at
    https://colab.research.google.com/drive/1aDHeQZTuMH0CMSoOb1pS7-DOuCgJZ7_1
...
model.fit(X, Y, batch_size = 5, epochs=40)

model.save('./tr_model_t.h5')
...
model.save('./models/tr_model_t.h5')